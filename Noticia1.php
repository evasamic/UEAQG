...
$query = "SELECT * FROM noticia1 WHERE idN1 = 1";  // Suponiendo que quieres obtener la primera fila
...
<body>
        ...
        <ul>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-content" id="oferta-dropdown">
                    ...
                    <li><a href="Bachillerato.php" class="active">Bachillerato general unificado</a></li>
                </ul>
            </li>            
    ...
    <div>   
        <img src="<?php echo $row['ImagenN1']; ?>" alt="Noticia1 AQG" class="full-width-image">
    </div>

    <main class="elemental-container">
        <section id="elemental">
            <h2><?php echo $row['TituloN1']; ?></h2>
            <div class="title-line"></div> <!-- Línea verde debajo del título -->
            <p>
                <?php echo $row['Parrafo1N1']; ?>
            </p>
            <p>
                <?php echo $row['Parrafo2N1']; ?>
            </p>
            <p>
                <?php echo $row['Parrafo3N1']; ?>
            </p>
        </section>
    </main>
