...
$query = "SELECT * FROM noticia2 WHERE idN2 = 1";  // Suponiendo que quieres obtener la primera fila
...
<body>
    ...
    <div>   
        <img src="<?php echo $row['ImagenN2']; ?>" alt="Noticia2 AQG" class="full-width-image">
    </div>

    <main class="elemental-container">
        <section id="elemental">
            <h2><?php echo $row['TituloN2']; ?></h2>
            <div class="title-line"></div> <!-- Línea verde debajo del título -->
            <p>
                <?php echo $row['Parrafo1N2']; ?>
            </p>
            <p>
                <?php echo $row['Parrafo2N2']; ?>
            </p>
            <p>
                <?php echo $row['Parrafo3N2']; ?>
            </p>
        </section>
    </main>
