...
$query = "SELECT * FROM inicial WHERE idInicial = 1";  // Suponiendo que quieres obtener la primera fila
...
<div class="login-container">
        ...
        <ul>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-content" id="oferta-dropdown">
                    <li><a href="Inicial.php" class="active">Inicial</a></li>
    ...
    <div>   
        <img src="<?php echo $row['ImagenInicial']; ?>" alt="Inicial AQG" class="full-width-image">
    </div>

    <main class="elemental-container">
        <section id="elemental">
            <h2><?php echo $row['TituloInicial']; ?></h2>
            <div class="title-line"></div> <!-- Línea verde debajo del título -->
            <p>
                <?php echo $row['Parrafo1Inicial']; ?>
            </p>
            <p>
                <?php echo $row['Parrafo2Inicial']; ?>
            </p>
            <p>
                <?php echo $row['Parrafo3Inicial']; ?>
            </p>
            ...
            <div class="accordion-container">
                ...
                <div id="main-accordion-content" class="accordion-content">
                    ...
                    <!-- Sub-nivel 1 -->
                    <div class="accordion-container">
                        <button class="accordion-button" onclick="toggleGradeAccordion('5to')">Sub-nivel 1</button>
                        <div id="accordion-5to" class="accordion-content">
                            <button class="accordion-button" onclick="toggleAccordion('1')">Paralelo A</button>
                            <div id="accordion-content1" class="accordion-content">
                                <img src="<?php echo $row['ImagenHorario1Inicial']; ?>" class="horario">
                            </div>
                            <button class="accordion-button" onclick="toggleAccordion('2')">Paralelo B</button>
                            <div id="accordion-content2" class="accordion-content">
                                <img src="<?php echo $row['ImagenHorario2Inicial']; ?>" class="horario">
                            </div>
                            <button class="accordion-button" onclick="toggleAccordion('3')">Paralelo C</button>
                            <div id="accordion-content3" class="accordion-content">
                                <img src="<?php echo $row['ImagenHorario3Inicial']; ?>" class="horario">
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Sub-nivel 2 -->
                    <div class="accordion-container">
                        <button class="accordion-button" onclick="toggleGradeAccordion('6to')">Sub-nivel 2</button>
                        <div id="accordion-6to" class="accordion-content">
                            <button class="accordion-button" onclick="toggleAccordion('4')">Paralelo A</button>
                            <div id="accordion-content4" class="accordion-content">
                                <img src="<?php echo $row['ImagenHorario4Inicial']; ?>" class="horario">
                            </div>
                            <button class="accordion-button" onclick="toggleAccordion('5')">Paralelo B</button>
                            <div id="accordion-content5" class="accordion-content">
                                <img src="<?php echo $row['ImagenHorario5Inicial']; ?>" class="horario">
                            </div>
                            <button class="accordion-button" onclick="toggleAccordion('6')">Paralelo C</button>
                            <div id="accordion-content6" class="accordion-content">
                                <img src="<?php echo $row['ImagenHorario6Inicial']; ?>" class="horario">
                            </div>
                        </div>
                    </div>
                </div>
